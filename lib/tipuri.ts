...
export enum TipDiagrama {
  DONUT = "DONUT",
  BAR = "BAR",
  LINE = "LINE",
}

export type ParametruFiltru = {
  coloana: string;
  eticheta: string;
  valoare: string;
  pagina: string;
...
export type RaspunsTrimitereEmail = {
  mesaj: string;
  status: number;
  ok: boolean;
};

export const MapComponentaDiagrama = (tip: TipDiagrama) => {};

export enum TipDiagramaT {
  VANZARI_TOTALE,
  UTILIZATORI_TOTALE,
  BILETE_VANDUTE,
}

export type TipDateDiagrama = {
  data: {
    numeCheie: any;
    cheieDate: any;
  }[];
...
export type ArrayIntervaleSelectare = {
  coloane: string;
  value: string;
};

export const ListaIntervaleSelectare: ArrayIntervaleSelectare[] = [
  { coloane: "Azi", value: "azi" },
  { coloane: "Ieri", value: "ziuaTrecuta" },
  { coloane: "Saptamna curenta", value: "ultimele7Zile" },
  { coloane: "Luna curenta", value: "ultimele30Zile" },
  { coloane: "Acum 3 luni", value: "ultimele90Zile" },
  { coloane: "Acum 6 luni", value: "ultimele6Luni" },
  { coloane: "Acum 9 luni", value: "ultimele9Luni" },
];

export enum TipuriTabel {
  CLIENT = "Client",
  SPECTACOL = "Spectacol",
  CATEGORIE_SPECTACOL = "Categorie Spectacol",
  SEZON_SPECTACOL = "Sezon Spectacol",
...
export type AutentificareSesiune = {
  sesiune: Session | null;
  utilizator: Client | null;
  primaData: boolean;
  esteLogat: boolean;
};

export type ParametriFurnizorAutentificare = {
  url: string;
  linkCu: string;
  raspuns?: RaspunsTrimitereEmail;
};
...
export type RaspunsDecriptareSemnatura = {
  ok: boolean;
  status: number;
  date: {
    email: string;
    expiraLa: string;
    trimisDeURL: string | null;
  };
};

export type RaspunsVerificareResetareParola = {
  utilizator: string | null;
  URLRedirectare: string | null;

...
export const schemaCreareClient = z
	...
	.refine((data) => esteDataInTrecut(data.dataNasterii), {
		message: "Data nașterii trebuie să nu fie în viitor!",
		path: ["dataNasterii"],
	})
	.refine((data) => esteDataCuOLunaInUrma(data.dataNasterii), {
...
export const schemaActualizareClient = z
	...
	.refine((data) => esteParolaPuternica(data.parola), {
		message:
...
export const schemaCreareLocSalaSpectacol = z
	...
	.refine((data) => esteNumeric(data.pretLoc), {
...
export const schemaCreareFacturaFiscala = z
	...
	.refine((data) => esteNumeric(data.sumaPlatita), {
...
export const schemaCreareMaterialDecorSpectacol = z
	...
	.refine((data) => esteNumeric(data.cantitateStoc), {
		message: "Stocul este invalid, trebuie să fie un număr!",
		path: ["cantitateStoc"],
	})
	.refine((data) => esteNumeric(data.pretAchizitie), {
...
export const schemaCreareMaterialDecorSpectacolFolosit = z
	...
	.refine((data) => esteNumeric(data.cantitateaFolosita), {
	...
	.refine((data) => esteNumeric(data.cantitateaRamasaPeStoc), {
		message:
